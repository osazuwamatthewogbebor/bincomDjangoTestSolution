"""
Django settings for bincomTestElection project.
...
ALLOWED_HOSTS = ['bincomdjangotestsolution.onrender.com.render.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'bincomTestElection.urls'
...
WSGI_APPLICATION = 'bincomTestElection.wsgi.application'
